  ...
  <div class="home m-0">
    <div class="h-12 bg-blue-500 w-screen lg:w-auto flex" id="menu">
      <nav class="float-right mx-auto lg:mx-0 items-center h-12 flex list-none lg:pr-4">
        ...
        <a href="https://github.com/YT-Main"><li class="py-3 px-4 hover:bg-white hover:text-blue-500 text-white transition duration-300 ease-in-out">Github</li></a>
      </nav>
    </div>
    <Intro id="intro" />
    <div class="flex w-full">
      <div class="mx-auto w-12 h-20 flex cursor-pointer" id="jumping-arrow"  @click="scroll('about')">
